			...
			<div class="row">
				...
				<div id="main" class="col-md-9">
					...
					<div class="store-filter clearfix">
							...
							<li><a href="motores.jsp"><i class="fa fa-caret-right"></i></a></li>
						</ul>
					</div> 
				</div>
					<!-- /store top filter -->
							...
							<div class="col-md-4 col-sm-6 col-xs-6">
								<div class="product product-single">
									<div class="product-thumb">
										...
										<button class="main-btn quick-view"><a href="product-page-Motor-800cc.jsp"><i class="fa fa-search-plus">Ver</i></a></button>
                                                                               <img src="./img/main-product10.jpg" alt=""> 
									</div>
									<div class="product-body">
										<h3 class="product-price">$2610000  <del class="product-old-price">$29000000</del></h3>
										...
										<h2 class="product-name"><a href="product-page-Motor-800cc.jsp">Motor 800cc Cerebro Electrónico</a></h2>
							...
							<div class="col-md-4 col-sm-6 col-xs-6">
								<div class="product product-single">
									<div class="product-thumb">
										...
										<button class="main-btn quick-view"><a href="product-page-Motor-Chrysler-Dodge.jsp"><i class="fa fa-search-plus">Ver</i></a></button>
                                                                               <img src="./img/main-product09.jpg" alt=""> 
									</div>
									<div class="product-body">
                                                                            <h3 class="product-price">$2356250 <!-- <del class="product-old-price">$157000</del>--></h3>
										<div class="product-rating">
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
										...
										<h2 class="product-name"><a href="product-page-Motor-Chrysler-Dodge.jsp">Motor Chrysler Dodge Ram 318</a></h2>
										<div class="product-btns">
											<button class="primary-btn add-to-cart"><i class="fa fa-money" ></i><a href="comprar.jsp"> Comprar</a></button>
										</div>
									</div>
							...
							<div class="col-md-4 col-sm-6 col-xs-6">
								<div class="product product-single">
									<div class="product-thumb">
										...
										<button class="main-btn quick-view"><a href="product-page-Motor-Chrysler.jsp"><i class="fa fa-search-plus">Ver</i></a></button>
                                                                               <img src="./img/main-product07.jpg" alt=""> 
									</div>
									<div class="product-body">
										<h3 class="product-price"> $8808750 <del class="product-old-price">$9787500</del></h3>
										<div class="product-rating">
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
										...
										<h2 class="product-name"><a href="product-page-Motor-Chrysler.jsp">Motor Chrysler</a></h2>
										<div class="product-btns">
											<button class="primary-btn add-to-cart"><i class="fa fa-money" ></i><a href="comprar.jsp"> Comprar</a></button>
										</div>
									</div>
							...
							<div class="col-md-4 col-sm-6 col-xs-6">
								<div class="product product-single">
									<div class="product-thumb">
										...
										<button class="main-btn quick-view"><a href="product-page-Motor-Cummins.jsp"><i class="fa fa-search-plus">Ver</i></a></button>
                                                                               <img src="./img/main-product08.jpg" alt=""> 
									</div>
									<div class="product-body">
										<h3 class="product-price">$10875000</h3>
										<div class="product-rating">
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
										...
										<h2 class="product-name"><a href="product-page-Motor-Cummins.jsp">Motor Diesel Cummins 6ct</a></h2>
										<div class="product-btns">
											<button class="primary-btn add-to-cart"><i class="fa fa-money" ></i><a href="comprar.jsp"> Comprar</a></button>
										</div>
									</div>
