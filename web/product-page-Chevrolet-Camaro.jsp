...
<head>
	...
	<title>Quercus-Chevrolet Camaro</title>
	...
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				<li><a href="principal.jsp">Inicio</a></li>
				<li>Vehiculos</li>
				<li class="active">Chevrolet Camaro</li>
			</ul>
		</div>
	</div>
	<!-- /BREADCRUMB -->
				...
				<div class="product product-details clearfix">
					<div class="col-md-9">
						<div id="product-main-view">
							...
							<div class="product-view">
								<img src="./img/Chevrolet-Camaro1.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="./img/Chevrolet-Camaro2.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="./img/Chevrolet-Camaro3.jpg" alt="">
							</div>
                                                        <div class="product-view">
								<img src="./img/Chevrolet-Camaro4.jpg" alt="">
							</div>
					...
					<div class="col-md-3">
						<div class="product-body">
							...
							<h2 class="product-name">Chevrolet Camaro</h2>
                                                        <h3 class="product-price">$197'450.000 </h3>
                                                        
							<p><strong>Serial: </strong> 8737 </p>
						...
						<div class="product-tab">
							...
							<div class="tab-content">
								<div id="tab" class="tab-pane fade in active">
                                                                    <p> La Sexta generación de Camaro SS llega con un diseño totalmente nuevo, una arquitectura más atletica
                                                                        y liviana, respetando el ADN de su antecesor manteniendo solo dos de sus piezas, 
                                                                        el emblema del corbatín y la insignia SS.</p>

                                                                    <p> Sus lineas meticulosamente afinadas en el tunel del viento, 
                                                                        estan pensadas para perfeccionar su diseño aerodinámico 
                                                                        contribuyendo a su alto desempeño.</p>

                                                                    <p> Parrilla delantera con identidad Camaro, 
                                                                        faros delanteros incluidos, características que se 
                                                                        conservan desde la primera generacion. </p>

                                                                    <p> Diseño aerodinámico con sutiles deflectores de aire en la 
                                                                        parte posterior delantera que guia el aire alrededor de 
                                                                        las ruedas para ayudar a reducir la fricción.</p>

                                                                    <p> Faros traseros expresivos que mezclan la estética horizontal 
                                                                        del Camaro de primera generación con un diseño de doble elemento 
                                                                        y cubiertas agresivas para una apariencia contemporánea.  </p>
                                                                    
                                                                    <p> El panel de instrumentos es una interpretación moderna 
                                                                        de la primera generación de Camaro, tanto la consola como la posición
                                                                        de conducción fueron diseñados para optimizar la ergonomía al momento de conducir.</p>                                     
								
                                                                    <p> El nuevo Camaro SIX es capaz de evitar los ruidos molestos 
                                                                        gracias al - Active Noise Cancellation - una innovadora tecnología que consta
                                                                        de unos micrófonos imperceptibles que reciben y transmiten las frecuencias 
                                                                        molestas a un módulo de control, el cual a su vez genera unas frecuencias inversa
                                                                        a través de los parlantes cancelando las ondas de sonido.</p>
                                                                
                                                                </div>
                                                                <div id="tab1" class="tab-pane fade in active">
                                                                        <p> <strong>Color:</strong>  Rojo </p>
                                                                        <p> <strong>Tipo:</strong> 4x2 </p>
                                                                        <p> <strong>Motor:</strong> 6.2 litros</p>
                                                                        <p> <strong>Potencia:</strong> 455 caballos de fuerza</p>
