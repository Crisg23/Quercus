...
<head>
	...
	<title>Quercus-Sensor flujo de aire</title>
	...
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				<li><a href="principal.jsp">Inicio</a></li>
				<li>Productos</li>
				<li class="active">Sensor flujo de aire</li>
			</ul>
		</div>
	</div>
	<!-- /BREADCRUMB -->
				...
				<div class="product product-details clearfix">
					...
					<div class="col-md-6">
						<div class="product-body">
							...
							<h2 class="product-name">Sensor flujo de aire</h2>
							<h3 class="product-price">$168.000 <del class="product-old-price">$210.000</del></h3>

							<p><strong>Referencia:</strong> 9456</p>
                                                        <p><strong>Garantía:</strong> 3 meses</p>
							<p>Sensor Flujo De Aire Tech Partes Kia Sportage
							</p>
