<%-- 
    Document   : vehiculos2
    Created on : 21/05/2018, 03:15:30 PM
    Author     : EDISON
--%>
...
<head>
	...
	<title>Todos los vehiculos 2</title>
                                        ...
                                        <div id="main" class="col-md-9">
                                                ...
                                                <div class="store-filter clearfix">
                                                        ...
                                                        <ul class="store-pages">
                                                                ...
                                                                <li><a href="vehiculos.jsp">1</a></li>
                                                                <li class="active">2</li>
                                                                <li><a href="vehiculos.jsp"><i class="fa fa-caret-right"></i></a></li>
                                                        </ul>
                                                </div>
                                                <!-- /store top filter -->
                                        </div>
							...
							<div class="col-md-4 col-sm-6 col-xs-6">
								<div class="product product-single">
									<div class="product-thumb">
										...
										<button class="main-btn quick-view"><a href="product-page-Ford-Fusion.jsp"><i class="fa fa-search-plus">Ver</i></a></button>
                                                                               <img src="./img/Ford-Fusion.jpeg" alt=""> 
									</div>
									<div class="product-body">
										<h3 class="product-price">$85'110.500 <del class="product-old-price">$89'590.000</del></h3>
										...
										<h2 class="product-name"><a href="product-page-Ford-Fusion.jsp">Ford Fusion</a></h2>
							...
							<div class="col-md-4 col-sm-6 col-xs-6">
								<div class="product product-single">
									<div class="product-thumb">
										...
										<button class="main-btn quick-view"><a href="product-page-Ford-Mustang.jsp"><i class="fa fa-search-plus">Ver</i></a></button>
                                                                               <img src="./img/Ford-Mustang.jpg" alt=""> 
									</div>
									<div class="product-body">
										<h3 class="product-price">$140'712.000<del class="product-old-price">$159'900.000</del></h3>
										<div class="product-rating">
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
										...
										<h2 class="product-name"><a href="product-page-Ford-Mustang.jsp">Ford Mustang</a></h2>
										<div class="product-btns">
											<button class="primary-btn add-to-cart"><i class="fa fa-drivers-license" ></i><a href="cotizar.jsp"> Cotizar</a></button>
										</div>
									</div>
							...
							<div class="col-md-4 col-sm-6 col-xs-6">
								<div class="product product-single">
									<div class="product-thumb">
										...
										<button class="main-btn quick-view"><a href="product-page-Ford-Explorer.jsp"><i class="fa fa-search-plus">Ver</i></a></button>
									...
									<div class="product-body">
										...
										<h2 class="product-name"><a href="product-page-Ford-Explorer.jsp">Ford Explorer</a></h2>
										<div class="product-btns">
											<button class="primary-btn add-to-cart"><i class="fa fa-drivers-license" ></i><a href="cotizar.jsp"> Cotizar</a></button>
										</div>
									</div>
