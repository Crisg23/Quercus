...
<head>
	...
	<title>Quercus-Ford Mustang</title>
	...
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				<li><a href="principal.jsp">Inicio</a></li>
				<li>Vehiculos</li>
				<li class="active">Ford Mustang</li>
			</ul>
		</div>
	</div>
	<!-- /BREADCRUMB -->
				...
				<div class="product product-details clearfix">
					<div class="col-md-9">
						<div id="product-main-view">
							<div class="product-view">
								<img src="./img/Ford-Mustang.jpg" alt="">
							</div>
                               
							<div class="product-view">
								<img src="./img/Ford-Mustang1.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="./img/Ford-Mustang2.jpg" alt="">
							</div>
                                                        <div class="product-view">
								<img src="./img/Ford-Mustang3.jpg" alt="">
							</div>
                                                        <div class="product-view">
								<img src="./img/Ford-Mustang4.jpg" alt="">
							</div>
                                                        <div class="product-view">
								<img src="./img/Ford-Mustang5.jpg" alt="">
							</div>
                                                        <div class="product-view">
								<img src="./img/Ford-Mustang6.jpg" alt="">
							</div>
					...
					<div class="col-md-3">
						<div class="product-body">
							...
							<h2 class="product-name">Ford Mustang</h2>
							<h3 class="product-price">$140'712.000
                                                        <del class="product-old-price">$159'900.000</del></h3>

							<p><strong>Serial: </strong> 1847  </p>
						...
						<div class="product-tab">
							...
							<div class="tab-content">
								<div id="tab" class="tab-pane fade in active">
                                                                    ...
                                                                    <p>El nuevo Mustang está diseñado para personalizarlo desde la manera que conduces, 
                                                                        el diseño del panel de instrumentos y el sonido de su rugido hasta como se siente tomar una curva. 
                                                                        Esta leyenda nació para ser personalizada.</p>

                                                                    <p>Ahora en la versión convertible, recorreras los caminos con una sensación de libertad indescriptible.
                                                                        Siente su poderoso Motor 5.0L V8, ahora con mayor potencia gracias a sus 460 HP y 420 lb/pie de torque, 
                                                                        ¡con 25 HP y 20 lb/pie que su predecesor!</p>

                                                                    <p>La nueva caja automática de 10 velocidades permite obtener cambios de marcha rápidos y
                                                                        precisos e incorpora levas en el volante para aquellos amantes del control.
                                                                        Esta es la mejor caja automática de todos los Mustang</p>

                                                                    <p>Equipado con un escape doble con cuatro puntas el cual contiene un escape de desempeño con válvula activa, 
                                                                        te permite controlar el volumen del rugido de tu Mustang, ese sonido que te transmite su poder.</p>

                                                                    <p>Al detectar un posible riesgo de colisión con el vehículo de adelante o con un peatón 
                                                                        que entra de improviso en la trayectoria, el sistema aplicará los frenos de forma automática 
                                                                        para prevenir totalmente o reducir las consecuencias de un eventual choque.</p>

                                                                    <p>Lane Keep Alert: Sistema de permanencia en el carril, detecta los márgenes 
                                                                        de la carretera y te alerta con una gentil vibración en el volante cuando el 
                                                                        vehículo se sale del carril</p>
								</div>
                                                                <div id="tab1" class="tab-pane fade in active">
                                                                        <p> <strong>Color:</strong>  Naranja, Gris, Azul </p>
                                                                        <p> <strong>Tipo:</strong> 4x2 </p>
                                                                        <p> <strong>Motor:</strong> 5 litros</p>
