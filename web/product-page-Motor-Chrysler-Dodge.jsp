...
<head>
	...
	<title>Quercus- Motor Chrysler Dodge Ram 318</title>
	...
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				<li><a href="principal.jsp">Inicio</a></li>
				<li>Productos</li>
				<li class="active">Motor Chrysler Dodge Ram 318</li>
			</ul>
		</div>
	</div>
	<!-- /BREADCRUMB -->
				...
				<div class="product product-details clearfix">
					...
					<div class="col-md-6">
						<div class="product-body">
							...
							<h2 class="product-name"> Motor Chrysler Dodge Ram 318</h2>
							<h3 class="product-price">$2'356.250</h3>

							<p><strong>Referencia:</strong> 318</p>
                                                        <p><strong>Garantía:</strong> 1 año</p>
							<p>Motor Diesel para un Dodge 
