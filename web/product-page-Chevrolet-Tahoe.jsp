...
<head>
	...
	<title>Quercus-Chevrolet Tahoe</title>
	...
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				<li><a href="principal.jsp">Inicio</a></li>
				<li>Vehiculos</li>
				<li class="active">Chevrolet Tahoe</li>
			</ul>
		</div>
	</div>
	<!-- /BREADCRUMB -->
				...
				<div class="product product-details clearfix">
					<div class="col-md-9">
						<div id="product-main-view">
							...
							<div class="product-view">
								<img src="./img/Chev_Tahoe1.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="./img/Chev_Tahoe2.jpg" alt="">
                                                        </div>
                                                        <div class="product-view">
								<img src="./img/Chev_Tahoe3.jpg" alt="">
							</div>
                                                        <div class="product-view">
								<img src="./img/Chev_Tahoe4.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="./img/Chev_Tahoe5.jpg" alt="">
                                                        </div>
                                                        <div class="product-view">
								<img src="./img/Chev_Tahoe6.jpg" alt="">
							</div>
					...
					<div class="col-md-3">
						<div class="product-body">
							...
							<h2 class="product-name">Chevrolet Tahoe</h2>
                                                        <h3 class="product-price">$275'000.000</h3>

							<p><strong>Serial: </strong> 8317</p>
						...
						<div class="product-tab">
							...
							<div class="tab-content">
								<div id="tab" class="tab-pane fade in active">
                                                                    <p> El imponente diseño exterior de la nueva generación de Chevrolet Tahoe, es producto de múltiples 
                                                                        estudios y desarrollos que logran un diseño sofisticado y totalmente aerodinámico.</p>

                                                                    <p> Chevrolet presenta una nueva generación de SUV 4x4, que mezcla un diseño exterior elegante y 
                                                                        moderno, con un interior tecnologico y seguro. Su expresivo exterior combina forma y 
                                                                        funcionalidad, mediante líneas estructurales que a su vez ofrecen una gran.</p>

                                                                    <p> Cuenta con parrilla frontal doble, paquete de iluminacióndistintivo con faros delanteros de 
                                                                        largo alcance y mayor penetración, luces de posición con tecnología LED, estribos laterales, 
                                                                        spoiler trasero, rines de 20 pulgadas, entre otros. </p>

                                                                    <p> El nuevo motor EcoTec3 5.3L V8 VVT de inyección directa, ha sido diseñado para generar mayor
                                                                        potencia y ofrecer un eficiente consumo de combustible, superior a cualquier otra SUV 4x4 de
                                                                        su segmento. Entrega 355 HP @ 519 Nm lo cual le permite tener un excelente desempeño y la 
                                                                        confianza necesaria para cualquier situación de manejo, aún en condiciones de carga completa 
                                                                        o arrastre.</p>

                                                                    <p> La Chevrolet TAHOE se encuentra equipada con una renovada transmisión automática hydramatic 
                                                                        de 6 velocidades y mandos secuenciales. Su excelente relación final de eje y su mejorado 
                                                                        coeficiente de fricción interno, permiten percibir una excelente respuesta en la aceleración. 
                                                                        Incluye una caja de transferencia 4x4 con bajo, que permite el accionamiento electrónico de
                                                                        la misma en velocidades de hasta 100km/h, pasando de 2WD a 4WD-Hi.</p>
								</div>
                                                                <div id="tab1" class="tab-pane fade in active">
                                                                        <p> <strong>Color:</strong>  Gris claro, Blanco, Rojo </p>
                                                                        <p> <strong>Tipo:</strong> 4x4 </p>
                                                                        <p> <strong>Motor:</strong> 5.3 litros</p>
                                                                        <p> <strong>Potencia:</strong> 310 caballos de fuerza</p>
