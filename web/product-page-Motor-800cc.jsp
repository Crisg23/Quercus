...
<head>
	...
	<title>Quercus-Motor 800cc</title>
	...
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				<li><a href="principal.jsp">Inicio</a></li>
				<li>Productos</li>
				<li class="active">Motor 800cc Cerebro Electrónico</li>
			</ul>
		</div>
	</div>
	<!-- /BREADCRUMB -->
				...
				<div class="product product-details clearfix">
					...
					<div class="col-md-6">
						<div class="product-body">
							...
							<h2 class="product-name">Motor 800cc Cerebro Electrónico</h2>
							<h3 class="product-price">$2'610.000 <del class="product-old-price"> $2'900.000</del></h3>

							<p><strong>Referencia:</strong> 800</p>
                                                        <p><strong>Garantía:</strong> 1 año</p>
							<p>Motor Eléctrico especializado
							</p>
