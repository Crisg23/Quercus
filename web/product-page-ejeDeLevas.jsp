...
<head>
	...
	<title>Quercus-Eje de levas</title>
	...
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				<li><a href="principal.jsp">Inicio</a></li>
				<li>Productos</li>
				<li class="active">Eje de levas</li>
			</ul>
		</div>
	</div>
	<!-- /BREADCRUMB -->
				...
				<div class="product product-details clearfix">
					...
					<div class="col-md-6">
						<div class="product-body">
							...
							<h2 class="product-name">Eje de levas</h2>
							<h3 class="product-price">$78.300 <del class="product-old-price">$90.000</del></h3>

							<p><strong>Referencia:</strong> 9950</p>
                                                        <p><strong>Garantía:</strong> 3 meses</p>
							<p>Solenoide Eje De Levas De Chevrolet Sonic, Cruze Y Tracker 
							</p>
						...
						<div class="product-tab">
							...
							<div class="tab-content">
								<div id="tab" class="tab-pane fade in active">
                                                                       <p>SOLENOIDE EJE DE LEVAS DE CHEVROLET CRUZE</p>
                                                                       <p>Sirve para Chevrolet Cruze. Sonic y Tracker</p>
							        </div>
						</div>
					</div>
