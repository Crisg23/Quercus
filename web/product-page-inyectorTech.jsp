...
<head>
	...
	<title>Quercus-Inyector Tech</title>
	...
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				<li><a href="principal.jsp">Inicio</a></li>
				<li>Productos</li>
				<li class="active">Inyector Tech</li>
			</ul>
		</div>
	</div>
	<!-- /BREADCRUMB -->
				...
				<div class="product product-details clearfix">
					...
					<div class="col-md-6">
						<div class="product-body">
							...
							<h2 class="product-name">Inyector Tech</h2>
							<h3 class="product-price">$149.150 <del class="product-old-price">$157.000</del></h3>

							<p><strong>Referencia:</strong> 3705</p>
                                                        <p><strong>Garantía:</strong> 3 meses</p>
							<p>Inyector Tech Partes Hyundai Atos Prime
							</p>
