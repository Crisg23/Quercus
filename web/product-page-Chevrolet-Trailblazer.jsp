...
<head>
	...
	<title>Quercus-Chevrolet Trailblazer</title>
	...
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				<li><a href="principal.jsp">Inicio</a></li>
				<li>Vehiculos</li>
				<li class="active">Chevrolet Trailblazer</li>
			</ul>
		</div>
	</div>
	<!-- /BREADCRUMB -->
				...
				<div class="product product-details clearfix">
					<div class="col-md-9">
						<div id="product-main-view">
							...
							<div class="product-view">
								<img src="./img/Chev_Trail1.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="./img/Chev_Trail2.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="./img/Chev_Trail3.jpg" alt="">
							</div>
                                                        <div class="product-view">
								<img src="./img/Chev_Trail4.jpg" alt="">
							</div>
                                                        <div class="product-view">
								<img src="./img/Chev_Trail5.jpg" alt="">
							</div>
					...
					<div class="col-md-3">
						<div class="product-body">
							...
							<h2 class="product-name">Chevrolet Trailblazer</h2>
                                                        <h3 class="product-price">$138'000.000
                                                        <del class="product-old-price">$150'000.000</del></h3>

							<p><strong>Serial: </strong> 4781</p>
					...
					<div class="col-md-12">
						<div class="product-tab">
							<ul class="tab-nav">
								<li class="active"><a data-toggle="tab" href="#tab">Descripción</a></li>
								<li><a data-toggle="tab" href="#tab1">Detalles</a></li>
							</ul>
							<div class="tab-content">
								<div id="tab" class="tab-pane fade in active">
                                                                    <p> Sus nuevas líneas demarcadas y su estilizada parilla doble combinada con los faros
                                                                        envolventes y luces LED para circulación diurna expresan el carácter auténtico de una 
                                                                        4X4 de vanguardia con todo el ADN de la nueva Chevrolet.</p>

                                                                    <p> 7 puestos y cojiería en cuero para que tus compañeros de viaje vayan cómodos y además 
                                                                        entrentenidos gracias a Chevystar My Link de última generación, el cuál es compatible 
                                                                        con con Smartphone integration y Android Auto de tal manera que puedas disfrutar de 
                                                                        todos los contenidos y muchas de las aplicaciónes de tu teléfono inteligente proyectadas
                                                                        en la pantalla de 8" y a través del sistema de audio premium, además no perderás tu ruta 
                                                                        gracias a la opción de navegación. Eso sin mencionar que gracias a Chevystar además 
                                                                        tienes un conserje a bordo y puedes acceder a servicios remotos a través del App.</p>

                                                                    <p> El aire acondicionado automático dual llegará hasta la última fila de sillas de tal
                                                                        manera que todos estén a gusto. Igualmente para esos largos trayectos el control de
                                                                        crucero facilitará la conducción. También para concentrarse únicamente en el camino 
                                                                        la nueva Chevrolet Trailblazer cuenta con luces automáticas, DRLs, sensor de lluvia 
                                                                        y espejos colapsibles eléctricamente.</p>

                                                                    <p> Su motor Duramax 2.8 TurboDIESEL , Euro IV que entrega 197 caballos y 500 Nm de Torque,
                                                                        rendimientos sobresalientes en su segmento. Se trata de un motor common rail con turbo 
                                                                        de geometría variable lo cual significa que de acuerdo al rango de revoluciones del motor,
                                                                        el turbo ajusta su configuración para garantizar la entrega máxima de fuerza, es decir 
                                                                        que desde bajas revoluciones el Turbo está trabajando, logrando así, entregar toda la 
                                                                        fuerza y una reducir significativamente el consumo de combustible. Esta combinación de 
                                                                        motor Turbo DIESEL y transmisión automática de 6 velocidades permite alto rendimiento 
                                                                        sin sacrificar la sensación suave y confortable de manejo .</p>  
                                                                    
								</div>
                                                                <div id="tab1" class="tab-pane fade in active">
                                                                        <p> <strong>Color:</strong>  Gris Claro,Negro </p>
                                                                        <p> <strong>Tipo:</strong> 4x4 </p>
                                                                        <p> <strong>Motor:</strong> 2.8 litros</p>
                                                                        <p> <strong>Potencia:</strong> 197 caballos de fuerza</p>
