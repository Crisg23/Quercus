...
<head>
	...
	<title>Quercus-Chevrolet Cruze</title>
				...
				<div class="product product-details clearfix">
					<div class="col-md-9">
						<div id="product-main-view">
							...
							<div class="product-view">
								<img src="./img/Chevrolet-Cruze1.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="./img/Chevrolet-Cruze2.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="./img/Chevrolet-Cruze3.jpg" alt="">
							</div>
					...
					<div class="col-md-3">
						<div class="product-body">
							...
							<h2 class="product-name">Chevrolet Cruze</h2>
                                                        <h3 class="product-price">$76'320.000 </h3>

							<p><strong>Serial: </strong> 6597 </p>
						...
						<div class="product-tab">
							...
							<div class="tab-content">
								<div id="tab" class="tab-pane fade in active">
                                                                    <p> Es el único en su segmento que cuenta con asistencia para mantener el carril asistente avanzado 
                                                                        de parqueo, alerta de colisión frontal, iluminación inteligente, alerta de punto ciego e indicador 
                                                                        de distancia del vehículo delantero.</p>

                                                                    <p> Los 113 Kg menos y 68 mm más largo que la versión anterior hacen del nuevo Cruze un vehículo más ligero,
                                                                        ágil, seguro y con un increíble consumo de combustible de hasta 64 Km/gal en carretera.</p>

                                                                    <p> Nuevo motor Ecotec de 1.4 litros turbocargado que ofrece 153 hp y 240 Nm acoplado a una transmisión 
                                                                        automática Hydra-Matic de 6 velocidades. </p>

                                                                    <p> Cadena de repartición de dientes invertidos: reduce el ruido y ofrece alta durabilidad con bajos costos 
                                                                        de mantenimiento</p>

                                                                    <p> Para que puedas mantenerte firme en el camino, el nuevo Chevrolet Cruze cuenta con asistente de 
                                                                        permanencia en carril. Un sistema que te alerta cuando te desvías de tu curso y corrige la dirección 
                                                                        automáticamente, para que no tengas nada de qué preocuparte.  </p>
                                                                    
                                                                    <p> Cuando la velocidad es mayor a 60 km/h, esta tecnología, que funciona a través de un sistema de cámaras,
                                                                        monitorea las líneas de seguridad vial y puede girar suavemente el volante si 
                                                                        detecta que el vehículo empieza a cambiar de carril sin utilizar la señal de giro.</p>                                     
								</div>
                                                                <div id="tab1" class="tab-pane fade in active">
                                                                        <p> <strong>Color:</strong>  Azul </p>
                                                                        <p> <strong>Tipo:</strong> 4x2 </p>
                                                                        <p> <strong>Motor:</strong> 1.4 litros</p>
                                                                        <p> <strong>Potencia:</strong> 153 caballos de fuerza</p>
