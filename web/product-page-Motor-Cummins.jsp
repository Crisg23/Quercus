...
<head>
	...
	<title>Quercus-Motor Diesel Cummins 6ct</title>
	...
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				<li><a href="principal.jsp">Inicio</a></li>
				<li>Productos</li>
				<li class="active">Motor Diesel Cummins 6ct</li>
			</ul>
		</div>
	</div>
	<!-- /BREADCRUMB -->
				...
				<div class="product product-details clearfix">
					...
					<div class="col-md-6">
						<div class="product-body">
							...
							<h2 class="product-name">Motor Diesel Cummins 6ct</h2>
							<h3 class="product-price">$10'875.000</h3>

							<p><strong>Referencia:</strong> 654</p>
                                                        <p><strong>Garantía:</strong> 1 año</p>
							<p>Motor diesel de alto poder
							</p>
