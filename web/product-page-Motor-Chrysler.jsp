...
<head>
	...
	<title>Quercus-Motor Chrysler</title>
	...
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				<li><a href="principal.jsp">Inicio</a></li>
				<li>Productos</li>
				<li class="active">Motor Chrysler</li>
			</ul>
		</div>
	</div>
	<!-- /BREADCRUMB -->
				...
				<div class="product product-details clearfix">
					...
					<div class="col-md-6">
						<div class="product-body">
							...
							<h2 class="product-name">Motor Chrysler</h2>
							<h3 class="product-price">$8'808.750 <del class="product-old-price"> $9'787.500</del></h3>

							<p><strong>Referencia:</strong> 857</p>
                                                        <p><strong>Garantía:</strong> 1 año</p>
							<p>Motor V8 para Dodge a base de diesel
							</p>
