...
<head>
	...
	<title>Quercus-Chevrolet Equinox</title>
	...
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				<li><a href="principal.jsp">Inicio</a></li>
				<li>Vehiculos</li>
				<li class="active">Chevrolet Equinox</li>
			</ul>
		</div>
	</div>
	<!-- /BREADCRUMB -->
				...
				<div class="product product-details clearfix">
					<div class="col-md-9">
						<div id="product-main-view">
							...
							<div class="product-view">
								<img src="./img/Chev_Equinox1.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="./img/Chev_Equinox2.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="./img/Chev_Equinox3.jpg" alt="">
							</div>
                                                        <div class="product-view">
								<img src="./img/Chev_Equinox4.jpg" alt="">
							</div>
                                                        <div class="product-view">
								<img src="./img/Chev_Equinox5.jpg" alt="">
							</div>
					...
					<div class="col-md-3">
						<div class="product-body">
							...
							<h2 class="product-name">Chevrolet Equinox</h2>
                                                        <h3 class="product-price">$93'000.000</h3>

							<p><strong>Serial: </strong> 7924</p>
						...
						<div class="product-tab">
							...
							<div class="tab-content">
								<div id="tab" class="tab-pane fade in active">
                                                                    <p>La nueva Chevrolet Equinox es una SUV diseñada para tener una vida a bordo totalmente confortable y segura. 
                                                                        Cuenta con el mejor espacio interior de su categoría permitiendo gran amplitud para los 5 ocupantes. 
                                                                        Por eso, está enfocada principalmente a familias que viajan con sus hijos frecuentemente pero que también 
                                                                        están preocupados por tener lo último en seguridad y conectividad.</p>

                                                                    <p> La Equinox satisface a los clientes más exigentes que buscan un vehículo que les permita viajar plácidamente, 
                                                                        pero también se desenvuelve con comodidad en el tránsito urbano, con un bajo consumo de combustible y con toda
                                                                        la conectividad que se requiere en el mundo de hoy.</p>

                                                                    <p> Adicionalmente, la Equinox permite escapadas ocasionales fuera del asfalto, gracias a su sistema AWD con botón de 
                                                                        activación en la consola central. Así se tendrá toda la comodidad, tranquilidad y seguridad tanto en la carretera 
                                                                        como fuera de ella. Contar con un motor turbo, evita las pérdidas de potencia y además permite disponer de todo el 
                                                                        torque desde 2.000 RPM para poder realizar sobrepasos con mayor facilidad.</p>

                                                                    <p> La nueva Chevrolet Equinox cuenta con una transmisión automática de 6 velocidades con función tip up / tip down. 
                                                                        Contar con 6 marchas hacia adelante implica un excelente escalonamiento al circular en la ciudad o en carretera. 
                                                                        Así, el desempeño siempre será óptimo. Además, la caja se adapta de manera automática a los requerimientos del 
                                                                        conductor según requiera potencia inmediata o quiera una marcha tranquila que genere un bajo consumo de combustible.</p>        
                                                                    
								</div>
                                                                <div id="tab1" class="tab-pane fade in active">
                                                                        <p> <strong>Color:</strong>  Rojo, Negro </p>
                                                                        <p> <strong>Tipo:</strong> 4x4 </p>
                                                                        <p> <strong>Motor:</strong> 1.5 litros</p>
                                                                        <p> <strong>Potencia:</strong> 170 caballos de fuerza</p>
                                                                        <p><strong>Pasajeros:</strong>  8</p>    
								</div>
							</div>
						</div>
					</div>
