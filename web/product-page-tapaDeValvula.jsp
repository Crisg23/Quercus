<%-- 
    Document   : product-page-tapaDeValvula
    Created on : 21/05/2018, 03:12:51 PM
    Author     : EDISON
--%>
...
<head>
	...
	<title>Quercus-Tapa de válvula</title>
	...
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				<li><a href="principal.jsp">Inicio</a></li>
				<li>Productos</li>
				<li class="active">Tapa de válvula</li>
			</ul>
		</div>
	</div>
	<!-- /BREADCRUMB -->
				...
				<div class="product product-details clearfix">
					...
					<div class="col-md-6">
						<div class="product-body">
							...
							<h2 class="product-name">Tapa de válvula</h2>
							<h3 class="product-price">$897.300 <del class="product-old-price">$997.000</del></h3>

							<p><strong>Referencia:</strong> 4553</p>
                                                        <p><strong>Garantía:</strong> 3 meses</p>
							<p>Tapa de valvula Ford Focus 2.0 Duratec
							</p>
						...
						<div class="product-tab">
							...
							<div class="tab-content">
								<div id="tab" class="tab-pane fade in active">
                                                                    <p>Aplica para:</p>
                                                                        <p>Ford ecosport 2.0 duratec</p>
                                                                        <p>Ford focus 2.0 duratec</p>
                                                                        <p>Ford ranger 2.3</p>
                                                                        <p>Mazda 3/6 2.0 2.3</p>
                                                                </div>
                                                        </div>
                                                </div>
