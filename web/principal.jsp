<%-- 
    Document   : index
    Created on : 21/05/2018, 02:36:44 PM
    Author     : EDISON
--%>
            ...
            <div class="home-wrap">
                ...
                <div id="home-slick">
                    ...
                    <div class="banner banner-1">
                        ...
                        <div class="banner-caption text-center">
                            <h1>Ford Fiesta</h1>
                            <h3 class="white-color font-weak">Up to 22% Discount</h3>
                            <button class="primary-btn"><a href="product-page-Ford-Fiesta.jsp">Ver</a></button>
                    ...
                    <div class="banner banner-1">
                        ...
                        <div class="banner-caption">
                            <h1 class="primary-color">Eje de levas<br><span class="white-color font-weak">Up to 13% Discount</span></h1>
                            <button class="primary-btn"><a href="product-page-ejeDeLevas.jsp"> Comprar</a></button>
                        </div>
                    </div>
                    <!-- /banner -->
                    ...
                    <div class="banner banner-1">
                        ...
                        <div class="banner-caption">
                            <h1 class="primary-color">Chevrolet Trailblazer <span>Up to 18% Discount</span></h1>
                            <button class="primary-btn"><a href="product-page-Chevrolet-Trailblazer.jsp" >Ver</a></button>
                        </div>
                    </div>-
                    <!-- /banner -->
                    ...
                    <div class="banner banner-1">
                        ...
                        <div class="banner-caption text-center">
                            <h1>Conoce todos <br><span class="white-color font-weak">nuestros vehiculos</span> </h1>
                            <button class="primary-btn"><a href="vehiculos.jsp">Ir</a></button>
                    ...
                    <div class="banner banner-1">
                        ...
                        <div class="banner-caption text-center">
                            <h1>Nuevos motores</h1>
                            <h3 class="black-color font-weak">DESCUENTOS</h3>
                            <button class="primary-btn"><a href="motores.jsp">Ver</a></button>
