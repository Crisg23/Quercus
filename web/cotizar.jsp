<%-- 
    Document   : cotizar
    Created on : 3/06/2018, 12:27:11 AM
    Author     : Paola
--%>
...
<html>
	...
	<!-- /BREADCRUMB -->
		...
		<div class="container">
			<!-- row -->
			<div class="row">
                            <h3 class="title">COTIZAR</h3>
                                <div class="section-title"></div>
        <table class="table-responsive">
                <tr>
                    <th> Identificación <i class="fa fa-address-card-o"</th>
                    <th><input type="text" name="id_Cliente"  onkeypress="return solonumero(event)" required/> </th>
                </tr>
                ...
                <tr>
                    ...
                    <th><input type="text" name="nombres"  onkeypress="return soloLetras(event)" required/> </th>
                </tr>
                ...
                <tr>
                    ...
                    <th><input type="text" name="apellidos" onkeypress="return soloLetras(event)" required/> </th>
                </tr>
                ...
                <tr>
                    ...
                    <th><input type="text" name="e_mail" required/> </th>
                </tr>
                ...
                <tr>
                    ...
                    <th><input type="text" name="telefono"  onkeypress="return solonumero(event)" required/> </th>
                </tr>
                ...
                <tr>
                    ...
                    <th><input type="text" name="ciudad" onkeypress="return soloLetras(event)" required/> </th>
                </tr>
                 ...
                 <tr>
                    <td colspan="2">
                        <a href="#popup" class="primary-btn">Enviar</a>
                        <div class="modal-wrapper" id="popup">
                            <div class="popup-contenedor">
                                <h2 > <a class="fa fa-check"></a>  ¡LISTO!</h2>
                                    <p>Nos estaremos comunicando lo mas pronto posible contigo.</p>
                                    <h3>Muchas gracias</h3>
                                    <a class="popup-cerrar" href="principal.jsp">X</a>
                            </div>
