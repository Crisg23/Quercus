<%-- 
    Document   : vehiculos
    Created on : 21/05/2018, 03:14:41 PM
    Author     : EDISON
--%>
            ...
            <div id="responsive-nav">
                ...
                <div class="menu-nav">
                    ...
                    <ul class="menu-list">
                        ...
                        <li>
                            <form name="reporte" action="/Quercus_Tienda/rptQuercus">
	...
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				...
				<li class="active">Todos los vehiculos</li>
			</ul>
		</div>
	</div>
	<!-- /BREADCRUMB -->
				...
				<div id="main" class="col-md-9">
					...
					<div class="store-filter clearfix">
						...
						<ul class="store-pages">
							...
							<li><a href="vehiculos2.jsp">2</a></li>
							<li><a href="vehiculos2.jsp"><i class="fa fa-caret-right"></i></a></li>
						</ul>
					</div> 
				</div>
					<!-- /store top filter -->
							...
							<div class="col-md-4 col-sm-6 col-xs-6">
								<div class="product product-single">
									<div class="product-thumb">
										...
										<button class="main-btn quick-view"><a href="product-page-Chevrolet-Camaro.jsp"><i class="fa fa-search-plus">Ver</i></a></button>
                                                                               <img src="./img/Chevrolet-Camaro.jpg" alt=""> 
									</div>
									<div class="product-body">
										<h3 class="product-price">$194'750.000</h3>
										...
										<h2 class="product-name"><a href="product-page-Chevrolet-Camaro.jsp">Chevrolet Camaro</a></h2>
							...
							<div class="col-md-4 col-sm-6 col-xs-6">
								<div class="product product-single">
									<div class="product-thumb">
										...
										<button class="main-btn quick-view"><a href="product-page-Chevrolet-Cruze.jsp"><i class="fa fa-search-plus">Ver</i></a></button>
                                                                               <img src="./img/Chevrolet-Cruze.jpg" alt=""> 
									</div>
									<div class="product-body">
										<h3 class="product-price">$76'320.000</h3>
										<div class="product-rating">
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
										...
										<h2 class="product-name"><a href="product-page-Chevrolet-Cruze.jsp">Chevrolet Cruze</a></h2>
										<div class="product-btns">
											<button class="primary-btn add-to-cart"><i class="fa fa-drivers-license" ></i><a href="cotizar.jsp"> Cotizar</a></button>
										</div>
									</div>
							...
							<div class="col-md-4 col-sm-6 col-xs-6">
								<div class="product product-single">
									<div class="product-thumb">
										...
										<button class="main-btn quick-view"><a href="product-page-Chevrolet-Equinox.jsp"><i class="fa fa-search-plus">Ver</i></a></button>
                                                                               <img src="./img/Chev_Equinox.jpg" alt=""> 
									</div>
									<div class="product-body">
										<h3 class="product-price">$93'000.000</h3>
										<div class="product-rating">
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
										...
										<h2 class="product-name"><a href="product-page-Chevrolet-Equinox.jsp">Chevrolet Equinox</a></h2>
										<div class="product-btns">
											<button class="primary-btn add-to-cart"><i class="fa fa-drivers-license" ></i><a href="cotizar.jsp"> Cotizar</a></button>
										</div>
									</div>
							...
							<div class="col-md-4 col-sm-6 col-xs-6">
								<div class="product product-single">
									<div class="product-thumb">
										...
										<button class="main-btn quick-view"><a href="product-page-Chevrolet-Onix.jsp"><i class="fa fa-search-plus">Ver</i></a></button>
                                                                               <img src="./img/Chevrolet-Onix.jpg" alt=""> 
									</div>
									<div class="product-body">
										<h3 class="product-price">$45'650.400 <del class="product-old-price">$49'620.000</del></h3>
										<div class="product-rating">
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
										...
										<h2 class="product-name"><a href="product-page-Chevrolet-Onix.jsp">Chevrolet Onix</a></h2>
										<div class="product-btns">
											<button class="primary-btn add-to-cart"><i class="fa fa-drivers-license" ></i><a href="cotizar.jsp"> Cotizar</a></button>
										</div>
									</div>
							...
							<div class="col-md-4 col-sm-6 col-xs-6">
								<div class="product product-single">
									<div class="product-thumb">
										...
										<button class="main-btn quick-view"><a href="product-page-Chevrolet-Tahoe.jsp"><i class="fa fa-search-plus">Ver</i></a></button>
                                                                               <img src="./img/Chev_Tahoe.jpg" alt=""> 
									</div>
									<div class="product-body">
										<h3 class="product-price">$275'000.000</h3>
										<div class="product-rating">
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
										...
										<h2 class="product-name"><a href="product-page-Chevrolet-Tahoe.jsp">Chevrolet Tahoe</a></h2>
										<div class="product-btns">
											<button class="primary-btn add-to-cart"><i class="fa fa-drivers-license" ></i><a href="cotizar.jsp"> Cotizar</a></button>
										</div>
									</div>
							...
							<div class="col-md-4 col-sm-6 col-xs-6">
								<div class="product product-single">
									<div class="product-thumb">
										...
										<button class="main-btn quick-view"><a href="product-page-Chevrolet-Trailblazer.jsp"><i class="fa fa-search-plus">Ver</i></a></button>
                                                                               <img src="./img/Chev_Trail.jpg" alt=""> 
									</div>
									<div class="product-body">
										<h3 class="product-price">$138'000.000 <del class="product-old-price">$150'000.000</del></h3>
										<div class="product-rating">
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
										...
										<h2 class="product-name"><a href="product-page-Chevrolet-Trailblazer.jsp">Chevrolet Trailblazer</a></h2>
										<div class="product-btns">
											<button class="primary-btn add-to-cart"><i class="fa fa-drivers-license" ></i><a href="cotizar.jsp"> Cotizar</a></button>
										</div>
									</div>
							...
							<div class="col-md-4 col-sm-6 col-xs-6">
								<div class="product product-single">
									<div class="product-thumb">
										...
										<button class="main-btn quick-view"><a href="product-page-Ford-Edge.jsp"><i class="fa fa-search-plus">Ver</i></a></button>
                                                                               <img src="./img/Ford-Edge.jpg" alt=""> 
									</div>
									<div class="product-body">
										<h3 class="product-price">$114'750.000 <del class="product-old-price">$135'000.000</del></h3>
										<div class="product-rating">
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
										...
										<h2 class="product-name"><a href="product-page-Ford-Edge.jsp">Ford Edge</a></h2>
										<div class="product-btns">
											<button class="primary-btn add-to-cart"><i class="fa fa-drivers-license" ></i><a href="cotizar.jsp"> Cotizar</a></button>
										</div>
									</div>
							...
							<div class="col-md-4 col-sm-6 col-xs-6">
								<div class="product product-single">
									<div class="product-thumb">
										...
										<button class="main-btn quick-view"><a href="product-page-Ford-Escape.jsp"><i class="fa fa-search-plus">Ver</i></a></button>
									...
									<div class="product-body">
										...
										<h2 class="product-name"><a href="product-page-Ford-Escape.jsp">Ford Escape</a></h2>
										<div class="product-btns">
											<button class="primary-btn add-to-cart"><i class="fa fa-drivers-license" ></i><a href="cotizar.jsp"> Cotizar</a></button>
										</div>
									</div>
							...
							<div class="col-md-4 col-sm-6 col-xs-6">
								<div class="product product-single">
									<div class="product-thumb">
										...
										<button class="main-btn quick-view"><a href="product-page-Ford-Fiesta.jsp"><i class="fa fa-search-plus">Ver</i></a></button>
                                                                               <img src="./img/Ford-Fiesta.jpg" alt=""> 
									</div>
									<div class="product-body">
										<h3 class="product-price">$35'638.200 <del class="product-old-price">$45'690.000</del></h3>
										<div class="product-rating">
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
										...
										<h2 class="product-name"><a href="product-page-Ford-Fiesta.jsp">Ford Fiesta</a></h2>
										<div class="product-btns">
											<button class="primary-btn add-to-cart"><i class="fa fa-drivers-license" ></i><a href="cotizar.jsp"> Cotizar</a></button>
										</div>
									</div>
